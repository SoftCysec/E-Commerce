# Generated by Django 4.1.5 on 2023-04-29 19:35
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(blank=True, choices=[('D', 'Dress'), ('S', 'Shirts'), ('J', 'Jeans'), ('SW', 'Swimwear'), ('SLW', 'Sleepwear'), ('SPW', 'Sportwear'), ('B', 'Blazers'), ('JA', 'Jackets'), ('SH', 'Shoes')], max_length=4, null=True)),
